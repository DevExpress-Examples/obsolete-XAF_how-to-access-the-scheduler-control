...
Namespace HowToAccessSchedulerControl.Win
   Partial Public Class HowToAccessSchedulerControlWindowsFormsApplication
	  ...
	  Private Sub HowToAccessSchedulerControlWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
