...
Namespace HowToAccessSchedulerControl.Win
    ...
    Public Partial Class HowToAccessSchedulerControlWindowsFormsApplication
        ...
        Private Sub HowToAccessSchedulerControlWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
